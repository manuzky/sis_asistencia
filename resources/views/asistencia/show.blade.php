                    ...
                    <div class="card-body">
                        <div class="box box-info padding-1">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="hora_entrada">Cédula</label>
                                        <input type="text" name="cedula" value="{{ old('cedula', number_format($asistencia->miembro->cedula, 0, '.', '.') ) }}" class="form-control{{ $errors->has('cedula') ? ' is-invalid' : '' }}" disabled>
