                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="pnf_id" id="pnf_id" class="form-control" required>
                                                    <option value="">--vacío--</option>
                                                    @foreach($pnfs as $pnf)
                                                        <option value="{{ $pnf->id }}" {{ old('pnf_id') == $pnf->id ? 'selected' : '' }}>{{ $pnf->nombre }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <select name="trayecto" id="trayecto" class="form-control" required>
                                                    <option value="">--vacío--</option>
                                                    <option value="Inicial" {{ old('trayecto') == 'Inicial' ? 'selected' : '' }}>Inicial</option>
                                                    <option value="1" {{ old('trayecto') == '1' ? 'selected' : '' }}>1</option>
                                                    <option value="2" {{ old('trayecto') == '2' ? 'selected' : '' }}>2</option>
                                                    <option value="3" {{ old('trayecto') == '3' ? 'selected' : '' }}>3</option>
                                                    <option value="4" {{ old('trayecto') == '4' ? 'selected' : '' }}>4</option>
                                                </select>
                                            </div>
                                        </div>
        ...
        document.getElementById('turno').addEventListener('change', function() {
            ...
            horas.forEach(function(hora) {
                ...
                ['Lunes', 'Martes', 'Miércoles', 'Jueves', 'Viernes'].forEach(function(dia) {
                    ...
                    input.setAttribute('data-dia', dia);  // Atributo para identificar el día de la semana
