                                    ...
                                    <tr>
                                        ...
                                        @can('miembros.toggle')
                                            <td style="text-align: center">
                                                @if($miembro->estado == '1')
                                                    <a href="{{ route('miembros.toggle', $miembro->id) }}" class="toggleButton btn btn-success btn-sm" style="border-radius: 20px">Activo</a>
                                                @else
                                                    <a href="{{ route('miembros.toggle', $miembro->id) }}" class="toggleButton btn btn-danger btn-sm" style="border-radius: 20px">Inactivo</a>
                                                @endif
                                            </td> 
                                        @endcan                                       
                                        <td style="text-align: center">
...
<div>
    ...
    {{-- SWEETALERT PARA BOTON DE ELIMINAR --}}
    <script>
    ...
    {{-- SWEETALERT RECARGA LA PÁGINA Y MUESTRA AVISO AL ELIMINAR --}}
